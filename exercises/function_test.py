...
def get_percentage(sequence, amino_acid=['A','I','L','M','F','W','Y','V']): #sets a default for amino_acid_list
    length = len(sequence)
    sequence.count(amino_acid) #amino_acid_count = 0 #sequence.count(amino_acid)
